...
앞에서 말한 Array List 와 달리 Linked List의 경우 값과 주소를 동시에 가지게 되는데 여기서 주소를 이용하여, 내가 원하는 값을 빨리 찾을 수 있다는 장점이 존재한다.  

기존 Array List의 경우 내가 원하는 값을 찾기 위해선 앞에서부터 맨끝까지 쭉 탐색을 했어야 했지만,  Linked List의 경우 주소